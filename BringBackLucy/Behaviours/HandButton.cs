...
namespace BringBackLucy.Tools
{
    public class HandButton : GTDoorTrigger
    {
        ...
        private IEnumerator PlayHorrorAudio()
        {
            ...
            using (UnityWebRequest www = UnityWebRequestMultimedia.GetAudioClip(url, AudioType.MPEG))
            {
                ...
                while (timer < clip.length)
                {
                    ...
                    {
                        audioSource.Stop();
                        Logging.Log("kinomods: Left room, stopping audio.");
                        yield break;
                    }
                ...
                Logging.Log("kinomods: Audio finished.. Teleporting to button..");
            }
        }
        ...
        private void SpawnFog()
        {
            ...
            {
                Logging.Log("kinomods: Not in modded lobby.");
                return;
            }
    ...
    // the fog code was written by iiDk, all credit goes to him!
    public class FogVisualizer : MonoBehaviour
    {
        ...
        void Update()
        {
            if (!NetworkSystem.Instance.InRoom || !NetworkSystem.Instance.GameModeString.Contains("MODDED"))
            {
                Logging.Log("kinomods: Left room or not in modded lobby. Destroying fog.");
                Destroy(gameObject);
                gameObject.Destroy();
                return;
            }
            ...
            if (GorillaLocomotion.GTPlayer.Instance != null && !hasFogged)
            {
                ...
                if (Forest_ZoneShaderSettings_Prefab != null)
                {
                    ...
                    typeof(ZoneShaderSettings).GetMethod("ApplyValues", System.Reflection.BindingFlags.Instance | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static)
                        .Invoke(Forest_ZoneShaderSettings_Prefab, new object[] { });
